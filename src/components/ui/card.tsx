...
export const Card = ({
  ...
  <div
    className={`rounded-2xl border border-stone-200 bg-white p-6 shadow-[0_10px_30px_rgba(120,113,108,0.06),0_1px_3px_rgba(120,113,108,0.02)] transition-all duration-300 ${className}`}
    {...rest}
  >
    {children}
  </div>
