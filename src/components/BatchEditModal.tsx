    ...
    <Modal onClose={onClose} className="modal-content">
      ...
      <div className="modal-body">
        ...
        <div className="form-group">
          ...
          <select id="cta-style" value={ctaStyle} onChange={(e) => setCtaStyle(e.target.value)}>
        ...
        <div className="form-group checkbox">
          <label>
            ...
            <span className="hint">
              All {totalPosts} posts will reset to optimized times for {currentPlatform}
            </span>
          </label>
        </div>
        ...
        <div className="preview-box">
          ...
          <ul className="preview-list">
            ...
            {!brandMention && !hashtag && !ctaStyle && !updateTimes && (
              <li className="empty">No changes selected</li>
            )}
          </ul>
        </div>
      </div>
