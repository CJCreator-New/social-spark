...
export default function FeedbackModal({
  ...
  return (
    <div className="card" style={{ maxWidth: 740, margin: "18px auto", padding: 18 }}>
      ...
      >
        <div style={{ flex: 1 }}>
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-accent px-2.5 py-1.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-primary">
            Regenerate feedback
          </div>
          <h3 style={{ margin: "8px 0 6px", fontFamily: "var(--font-display)", fontSize: 20 }}>
            What should change in this post?
          </h3>
          <div className="mb-2 text-muted-foreground">
            Add a short note so the rewrite can focus on tone, length, structure, or the CTA. This
            is optional, but specific feedback works better than a generic retry.
          </div>
        </div>
        <div style={{ display: "flex", gap: 8 }}>
          <button
            className="rounded-lg border border-border bg-transparent px-4 py-2 text-sm text-muted-foreground"
